...
int main(void){
	...
	printf("Try to read out secret data [%c]   =>   ", secretString[len] );
	...
	printf("Attack round ");	
        ...
        printf("  =>  Extracted data [%c] (# of cache hits : %d, ASCII : %d) \n", output[0], hitArray[0], output[0] ); 
